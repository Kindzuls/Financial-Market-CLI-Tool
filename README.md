...
## Project Structure
- `main.py` — The core application entry point containing data validation, analysis logic, and plotting.
- `MAD.py`, `RSI.py`, `SMA.py`, `import_finance.py` — Modular scripts for indicator calculations and data fetching.
- `text/` — Directory containing usage instructions (`usage.txt`) and execution examples (`examples.txt`).
- `screenshots/` — Visual output charts generated by the tool.
